...
function makeVASTRequest(url) {
  function getResponseObject(xhr) {
    ...
    let Creative = InLine.getElementsByTagName("Creatives")[0].getElementsByTagName("Creative")[0].getElementsByTagName("NonLinear")[0];
    let MediaFile = Creative.getElementsByTagName("MediaFiles")[0].getElementsByTagName("MediaFile")[0];
    let Duration = Creative.getElementsByTagName("Duration")[0];
